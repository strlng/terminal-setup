...
if [ `uname` == Darwin ]; then
	...
	mkdir -p ~/.vim/colors
	curl https://raw.githubusercontent.com/chriskempson/base16-vim/master/colors/base16-tomorrow-night.vim --output ~/.vim/colors/base16-tomorrow-night.vim

	echo "...Downloading base16-tomorrow-night iTerm color scheme"
	curl https://raw.githubusercontent.com/martinlindhe/base16-iterm2/master/itermcolors/base16-tomorrow-night.itermcolors --output /tmp/base16-tomorrow-night.itermcolors

	echo "...Converting base16-tomorrow-night iTerm color scheme to Apple Terminal color scheme"
	curl https://raw.githubusercontent.com/lysyi3m/osx-terminal-themes/master/tools/iterm2terminal.swift --output /tmp/iterm2terminal.swift
	...
	sed -i "" 's/BoldTextColor/TextColor/g' /tmp/iterm2terminal.swift

	chmod +x /tmp/iterm2terminal.swift
	/tmp/iterm2terminal.swift /tmp/base16-tomorrow-night.itermcolors

	open /tmp/base16-tomorrow-night.terminal
